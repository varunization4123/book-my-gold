...
import '/components/reward_component2/reward_component2_widget.dart';
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await Future.wait([
        ...
        Future(() async {
          ...
          FFAppState().discountModal = !(FFAppState().discountModal ?? true);
          setState(() {});
        }),
        Future(() async {
          if (!FFAppState().discountModal) {
            await showDialog(
                  ...
                  child: WebViewAware(
                    child: GestureDetector(
                      ...
                      child: SizedBox(
                        ...
                        child: const RewardComponent2Widget(),
                      ),
                    ),
                  ),
                );
                          ...
                          child: Row(
                            ...
                            children: [
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed('DailyBuyingPage');
                                },
                                child: wrapWithModel(
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed('WeeklyBuyingPage');
                                },
                                child: wrapWithModel(
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed('MonthlyBuyingPage');
                                },
                                child: wrapWithModel(

...
import 'monthly_buying_page_model.dart';
export 'monthly_buying_page_model.dart';

class MonthlyBuyingPageWidget extends StatefulWidget {
  const MonthlyBuyingPageWidget({super.key});

  @override
  State<MonthlyBuyingPageWidget> createState() =>
      _MonthlyBuyingPageWidgetState();
}

class _MonthlyBuyingPageWidgetState extends State<MonthlyBuyingPageWidget>
    with TickerProviderStateMixin {
  late MonthlyBuyingPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MonthlyBuyingPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'MonthlyBuyingPage'});
    // On page load action.

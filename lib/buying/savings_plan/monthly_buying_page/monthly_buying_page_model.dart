...
import 'monthly_buying_page_widget.dart' show MonthlyBuyingPageWidget;
import 'package:stop_watch_timer/stop_watch_timer.dart';
import 'package:flutter/material.dart';

class MonthlyBuyingPageModel extends FlutterFlowModel<MonthlyBuyingPageWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in MonthlyBuyingPage widget.
  AppSettingsRecord? readAppSettings;
  InstantTimer? mainTimer;
  InstantTimer? refreshTimer;
  // Stores action output result for [Backend Call - API (Buy Price API)] action in MonthlyBuyingPage widget.
  ApiCallResponse? goldPriceFromApi;
  // Stores action output result for [Custom Action - decryptApiResponse] action in MonthlyBuyingPage widget.

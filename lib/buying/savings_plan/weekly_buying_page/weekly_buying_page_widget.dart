...
import 'weekly_buying_page_model.dart';
export 'weekly_buying_page_model.dart';

class WeeklyBuyingPageWidget extends StatefulWidget {
  const WeeklyBuyingPageWidget({super.key});

  @override
  State<WeeklyBuyingPageWidget> createState() => _WeeklyBuyingPageWidgetState();
}

class _WeeklyBuyingPageWidgetState extends State<WeeklyBuyingPageWidget>
    with TickerProviderStateMixin {
  late WeeklyBuyingPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WeeklyBuyingPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WeeklyBuyingPage'});
    // On page load action.
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 20.0, 0.0, 0.0),
                                        child: Text(
                                          'Enter Amount You Want to Save Weekly',
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                          ...
                                          _model.encryptedBuyVerifyApiRequest =
                                            ...
                                            functions.buyVerifyData(
                                                ...
                                                _model.amountFieldTextController
                                                    .text,
                                                valueOrDefault<String>(
                                                  (((double.parse(_model.amountFieldTextController
                                                                          .text) /
                                                                      (_model
                                                                          .buyRate!)) *
                                                                  10000)

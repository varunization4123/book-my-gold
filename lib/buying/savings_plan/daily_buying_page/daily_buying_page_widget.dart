...
import 'daily_buying_page_model.dart';
export 'daily_buying_page_model.dart';

class DailyBuyingPageWidget extends StatefulWidget {
  const DailyBuyingPageWidget({super.key});

  @override
  State<DailyBuyingPageWidget> createState() => _DailyBuyingPageWidgetState();
}

class _DailyBuyingPageWidgetState extends State<DailyBuyingPageWidget>
    with TickerProviderStateMixin {
  late DailyBuyingPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DailyBuyingPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'DailyBuyingPage'});
    // On page load action.

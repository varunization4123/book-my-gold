...
import 'daily_buying_page_widget.dart' show DailyBuyingPageWidget;
import 'package:stop_watch_timer/stop_watch_timer.dart';
import 'package:flutter/material.dart';

class DailyBuyingPageModel extends FlutterFlowModel<DailyBuyingPageWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in DailyBuyingPage widget.
  AppSettingsRecord? readAppSettings;
  InstantTimer? mainTimer;
  InstantTimer? refreshTimer;
  // Stores action output result for [Backend Call - API (Buy Price API)] action in DailyBuyingPage widget.
  ApiCallResponse? goldPriceFromApi;
  // Stores action output result for [Custom Action - decryptApiResponse] action in DailyBuyingPage widget.

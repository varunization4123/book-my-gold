  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final sellingPageGoldPriceResponse = snapshot.data!;
                          ...
                          children: [
                            ...
                            Text(
                              valueOrDefault<String>(
                                formatNumber(
                                  GoldPriceCall.price(
                                    sellingPageGoldPriceResponse.jsonBody,
                                  ),
